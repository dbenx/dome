...
#####################################################################################
$wxmt = "#_@wxlogin";
$WxUserList = $YumDamSql->selectdb(" `ucname`,`wxid`,`wxname` ", $wxmt);
$WxUserListArray = array();
foreach ($WxUserList["select"] as $wxk => $wxv) {
    $WxUserListArray[$wxv["wxid"]] = $wxv["ucname"] . "(" . $wxv["wxname"] . ")";
}
##print_r($WxUserListArray);
?>
    ...
    <div class="Content">
        <table width="100%" border="0" cellspacing="1" cellpadding="1">
            ...
            foreach ($UserListC as $ck => $cv) {
                ...
                <tr>
                    <td><?= $i ?></td>
                    <td><?= $WxUserListArray[$cv["showpass"]] ?></td>
