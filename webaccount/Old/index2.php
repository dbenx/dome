...
<head>
    ...
    <style type="text/css">
        ...
        /*.sliderbox dd div a{ width:80px; height:30px; display:inline-block;}*/
...
<div class="MyMain">
        ...
        <dl class="sliderbox" id="sliderbox">
            ...
            <dd>
                ...
                <div><a href="./webaccount/Item.php?at=Item" target="mainframe">项目数据</a>&nbsp;<a
                            href="./webaccount/InData3.php?at=I" target="mainframe">新增</a></div>
                <div><a href="./webaccount/Item.php" target="mainframe">综合报表</a></div>
                <div><a href="./webaccount/Item.php?at=ms" target="mainframe">月度情况</a></div>
                <div><a href="./webaccount/Item.php?at=msm" target="mainframe">月度消费</a></div>
                <div><a href="./webaccount/Item.php?at=mst" target="mainframe">月度对话</a></div>
                <div><a href="./webaccount/Item.php?at=msi" target="mainframe">月度项目</a></div>
                <div style="display:none;"><a href="./webaccount/item.php?at=list" target="mainframe">项目报表</a></div>
                <div style="display:none;"><a href="./webaccount/item.php?at=listd" target="mainframe">商务通数据</a></div>
                <div style="display:none;"><a href="./webaccount/item.php?at=lstm" target="mainframe">投入数据</a></div>
                <div style="display:none;"><a href="./webaccount/mitem.php?at=list" target="mainframe">月报表</a></div>
            ...
            <dd>
                ...
                <div><a href="./Task/nc.php" target="mainframe">新增统计</a></div>
                <div><a href="./Task/ln.php" target="mainframe">查看统计</a></div>
                <div class="clearit" style="height:0px;"></div>
            </dd>
            ...
            <dd>
                ...
                <div><a href="./Login/logs.php" target="mainframe">登录情况</a></div>
                <div class="clearit" style="height:0px;"></div>
            </dd>
    ...
    <div class="Right">
        <div class="Right1">
            <div class="Right1C">&nbsp; &nbsp;欢迎您 <strong><?= $_SESSION["YumDamCname"] ?></strong> ！<span
                        id="TimeShow"></span></div>
        </div>
        <div class="Right3">
            <div class="Right3C">
