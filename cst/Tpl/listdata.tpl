...
<div class="Cont">
    <div class="Tinfo" style=" border-bottom:solid 1px #cccccc; height:50px; line-height:50px;">
        日期：<input type="text" value="2015-05-14" id="d1" class="InPutTxt"
                  style="width:120px; cursor:pointer; _cursor:hand;" readonly="readonly"
                  onclick="choose_date_czw('d1')"/> - <input type="text" value="2015-05-18" id="d2" class="InPutTxt"
    ...
    <div class="Content">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            ?>
            <tr>
                <td colspan="30" align="center"><strong>暂时没有可参考性数据！<a href="./?ma=<?=encode(" list")?>">点击查看数据</a>
                    </strong></td>
            </tr>
            <?
            }
