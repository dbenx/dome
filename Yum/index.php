...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td class="Right1">&nbsp; &nbsp;<a href="./maintips.php" target="mainframe">返回桌面</a>&nbsp; &nbsp;<a
                    href="./User/repass.php" target="mainframe">密码修改</a>&nbsp; &nbsp;欢迎您
            <strong><?= decode($_SESSION[encode("YumDamCname")]) ?></strong> ！<span id="TimeShow"></span></td>
    </tr>
    <tr>
        <td class="Left2" valign="top">
            <dl class="sliderbox" id="sliderbox">
                <dt class="open">新增数据</dt>
                <dd>
                    <div><a href="./webaccount/iList.php?f=l" target="mainframe">基础数据</a>&nbsp;|&nbsp;<a
                                href="./webaccount/" target="mainframe">新增</a></div>
                    <div><a href="./webaccount/bList.php?at=classlist" target="mainframe">来源数据</a>&nbsp;|&nbsp;<a
                                href="./webaccount/inclass.php?f=n" target="mainframe">新增</a></div>
                    <div><a href="./webaccount/bList.php?at=itemlist" target="mainframe">项目数据</a>&nbsp;|&nbsp;<a
                                href="./webaccount/initem.php?f=n" target="mainframe">新增</a></div>
                    <div><a href="./webaccount/bList.php?at=classitemlist" target="mainframe">综合报表</a></div>
                    <div class="clearit" style="height:0px;"></div>
                </dd>
                <?
                if ($YumDamGId == ecode("1")) {
                    ?>
                    <dt class="open">用户管理</dt>
                    <dd>
                        <div><a href="./User/repass.php" target="mainframe">密码修改</a></div>
                        <div><a href="./User/user.php" target="mainframe">添加用户</a></div>
                        <div><a href="./User/user.php" target="mainframe">用户管理</a></div>
