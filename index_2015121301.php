...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
                ...
                if ($YumDamGId == "3" || $YumDamGId == "1") {
                    ...
                    <dd>
                        ...
                        <div><a href="./webaccount/Item.php?at=Item" target="mainframe">项目数据</a>&nbsp;<a
                                    href="./webaccount/InData3.php?at=I" style="display:none;" target="mainframe">新增</a>
                        </div>
                        ...
                        <div><a href="./webaccount/table.php?at=L" target="mainframe">对话情况</a></div>
                        <div class="clearit" style="height:0px;"></div>
                    </dd>
        ...
        <td class="Right1">&nbsp; &nbsp;<a href="./maintips.php" target="mainframe">返回桌面</a>&nbsp; &nbsp;<a
                    href="./Login/pr.php" target="mainframe">密码修改</a>&nbsp; &nbsp;欢迎您
            <strong><?= $_SESSION["YumDamCname"] ?></strong> ！<span id="TimeShow"></span></td>
    </tr>
    <tr>
        <td class="Right3">
