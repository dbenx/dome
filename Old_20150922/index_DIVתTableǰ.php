...
<div class="MyMain">
        ...
        <dl class="sliderbox" id="sliderbox">
            ...
            <dd>
                ...
                <div><a href="./webaccount/Item.php?at=Fm" target="mainframe">信息来源</a>&nbsp;<a
                            href="./webaccount/InData4.php?at=I" target="mainframe">新增</a></div>
                ...
                <div><a href="./webaccount/mItem.php?at=msi" target="mainframe">月度项目</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
                            href="./webaccount/Item.php?at=msid" target="mainframe">日</a></div>
    ...
    <div class="Right">
        <div class="Right1">
            <div class="Right1C">&nbsp; &nbsp;<a href="./maintips.php" target="mainframe">返回桌面</a>&nbsp; &nbsp;欢迎您
                <strong><?= $_SESSION["YumDamCname"] ?></strong> ！<span id="TimeShow"></span></div>
        </div>
        <div class="Right3">
            <div class="Right3C">
                <iframe width="100%" height="100%" name="mainframe" style="position:absolute;" id="mainframe"
                        scrolling="auto" frameborder="0" src="./maintips.php"></iframe>
                <div class="clearit"></div>
            </div>
            <div class="clearit"></div>
        </div>
