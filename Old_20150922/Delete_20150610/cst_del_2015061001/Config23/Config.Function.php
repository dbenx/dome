...
{
    if ($nowdata < $sysdata) {
        $returndata = "<font color=\"#FF0000\"><strong>" . $nowdata . $ld . "</strong></font>";
    } else {
...
function YumDamShowMsgExit($tipsinfo, $furl = '#', $wtime = '5')
{
    ...
    echo "<style type=\"text/css\">\n.ShowMsg{width:440px; height:120px; border:solid 2px #535353; position:absolute; top:50%; left:50%; margin:-80px 0px 0px -220px; font-size:16px; font-weight:bold; color:#333; line-height:40px; padding:30px 20px;}\n</style>\n</head>\n\n<body oncontextmenu=\"return false;\">\n";
