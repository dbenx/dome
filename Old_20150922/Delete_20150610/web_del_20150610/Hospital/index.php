...
<div class="Cont">
    ...
    if ($myaction == "new") {
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    if (CheckId($form) == true) {
                        ...
                        <tr>
                            ...
                            <td width="150"><input name="im" type="text" id="im" class="InPutTxt" style="width:150px"
                                                   value=""/></td>
                            <td align="right" width="200">手机投入</td>
                            <td width="150"><input name="mim" type="text" id="mim" class="InPutTxt" style="width:150px"
                                                   value=""/></td>
                            <td align="right" width="150">PC投入</td>
                            <td width="150">54646</td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
        ...
        $listshowtime = $listtoday - 3600 * 24 * 7;
        ...
        <div class="Tinfo" style="text-align:center; border-bottom:solid 1px #cccccc;">
            <strong>当前日期：<?= $listshowtody ?></strong>
        </div>
        <div class="Content">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
