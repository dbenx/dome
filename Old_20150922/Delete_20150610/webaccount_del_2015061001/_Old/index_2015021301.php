...
<div class="Cont">
    ...
    ?>
        ...
        <div class="Tinfo" style=" border-bottom:solid 1px #cccccc; height:50px; line-height:50px;">
            日期： <input type="text" value="<?= date("Y-m-d", $listshowmin) ?>" id="d1" class="InPutTxt"
                       style="width:100px"/> - <input type="text" value="<?= date("Y-m-d", $listshowmax) ?>" id="d2"
                                                      class="InPutTxt" style="width:100px"/> <input type="button"
                                                                                                    value="查询" id="sbtn"
                                                                                                    class="B"/>
        </div>
