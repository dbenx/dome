...
if ($myaction == "email") {
    ...
    $smtpemailto2 = "341613846@qq.com,383631211@qq.com,29233635@qq.com,61917291@qq.com,19899279@qq.com";
    ##########################################罗洪强380222560，杨莉341613846，陈清元383631211，李家元29233635，黄天运61917291，黄高伟19899279
...
if ($IsThisMinMonth == $IsThisMonth && $IsThisMaxMonth == $IsThisMonth) {
    ...
    if ($ThisMonthTask["row"] == 1) {
        ...
        $ThisMonthTaskShow = "<strong>本月（" . date("Y年m月", $ThisMonthTaskSelect["ymonth"]) . "）各指标情况</strong> - > 业绩指标（万元）：" . round($ThisMonthTaskSelect["outm"] / 10000, 2) . " [ 日：" . round($ThisMonthTaskSelect["outm"] / 10000 / 31, 2) . " ] &nbsp; 初诊指标（人）：" . $ThisMonthTaskSelect["firstcome"] . " [ 日：" . round($ThisMonthTaskSelect["firstcome"] / 31, 2) . " ] &nbsp; 咨询指标（人）：" . $ThisMonthTaskSelect["talkm"] . " [ 日：" . round($ThisMonthTaskSelect["talkm"] / 31, 2) . " ]";
    }
}
##########################################当月指标##########################################
?>
...
<div class="Cont">
    ...
    if ($myaction != "emailshow") {
        ...
        <div class="Tinfo">
            ...
            <div style="float:left; position:relative;">
                ...
                <div style="position:absolute; top:30px; left:0px; border:solid 1px #CCC; background:#eeeeee; padding:10px 5px; line-height:22px; width:500px; display:none;"
                ...
                foreach ($ListItemGroup as $kk => $vv) {
                    echo $vv["aname"] . "<br />咨询量：" . $vv["data"][1] . "人<br />咨询成本：" . round($vv["data"][2] / $vv["data"][1], 2) . "元/人<br />下单量：" . $vv["data"][0] . "人<br />下单成本：" . round($vv["data"][2] / $vv["data"][0], 2) . "元/人<br />消费：" . $vv["data"][2] . "元 <br /><br />";
                }
                ?>
                <br/>
                ----------------------------------------------------------------<br/>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            foreach ($List as $lk => $lv) {
                ...
                <tr>
                    ...
                    <td align="center" bgcolor="#CAE8F2"><?= round($lv["fmoney"] / $lv["fclick"], 2) ?>元</td>
            ...
            <tr>
                ...
                <td align="center"
                    bgcolor="#CAE8F2"><?= round($ListItemShowC["fmoney"] / $ListItemShowC["fclick"], 2) ?>元
                </td>
    ...
    <div class="Content" style="margin:15px 0px 0px 0px; line-height:30px;">
        <?
        foreach ($ListItemGroup as $kk => $vv) {
            echo $vv["aname"] . " ( 咨询量：" . $vv["data"][1] . "人&nbsp;|&nbsp;咨询成本：" . round($vv["data"][2] / $vv["data"][1], 2) . "元/人&nbsp;|&nbsp;下单量：" . $vv["data"][0] . "人&nbsp;|&nbsp;下单成本：" . round($vv["data"][2] / $vv["data"][0], 2) . "元/人&nbsp;|&nbsp;消费：" . $vv["data"][2] . "元 )<br>";
        }
        ?>
    </div>
        ...
        <div class="ItemR">
            ...
            foreach ($MonthAllItemContShowDataCont as $ik => $iv) {
                ...
                <div class="Item<? if ($ss % 2 == 1) {
                    ...
                    if ($iv[1] > 0) {
                        echo $ikshow . "|日" . "<br />" . $iv[1] . "|" . round($iv[1] / $today3, 2) . "人<br />" . $iv[0] . "|" . round($iv[0] / $today3, 2) . "人<br />" . $iv[2] . "|" . round($iv[2] / $today3, 2) . "元<br />" . $onetalkprice . "元";
                    }
                    ?>
                </div>
                <?
