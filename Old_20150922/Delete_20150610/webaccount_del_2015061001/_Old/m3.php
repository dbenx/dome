...
#print_r($ItemShowC2);
######################################################################################################
$ShowItem = $YumDamSql->selectdb(" $mt6.`fitem`,$mt4.`selecttime`,$mt4.`ismail` ", "$mt6,$mt4", "$mt6.`fdate`=$mt4.`Id` and $mt4.Id=$id");
...
######################################################################################################
######################################################################################################
$SelectDateMinDate = date('Ymd', strtotime(date("Ymd", $ItemListNowDate)) - 3600 * 24 * 2);
$SelectDateMin = strtotime($SelectDateMinDate . "00:00:00");
...
<div class="Cont">
    ...
    <div class="Content">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= $ListItemShowC["talkall"] ?>个</td>
                <td><?= $ListItemShowYesterdayC["talkall"] ?>
                    个
                </td>
                <td><?= $ListItemShowMonthC["talkall"] ?>个</td>
                <td>&nbsp;</td>
                <td align="right" bgcolor="#CCE9F0">手机对话：</td>
                <td><?= $ListItemShowC["talkwap"] ?>个</td>
                <td><?= $ListItemShowYesterdayC["talkwap"] ?>
                    个
                </td>
                <td><?= $ListItemShowMonthC["talkwap"] ?>个</td>
                <td>&nbsp;</td>
                <td align="right" bgcolor="#CCE9F0">PC对话：</td>
                <td><?= $ListItemShowC["talkall"] - $ListItemShowC["talkwap"] ?>个</td>
                <td><?= $ListItemShowYesterdayC["talkall"] - $ListItemShowYesterdayC["talkwap"] ?>
                    个
                </td>
                <td><?= $ListItemShowMonthC["talkall"] - $ListItemShowMonthC["talkwap"] ?>个</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td align="right" bgcolor="#CCE9F0">到院重复对话：</td>
                <td><?= $ListItemShowC["retalk1"] ?>个</td>
                <td><?= $ListItemShowYesterdayC["retalk1"] ?>
                    个
                </td>
                <td><?= $ListItemShowMonthC["retalk1"] ?>个</td>
                <td>&nbsp;</td>
                <td align="right" bgcolor="#CCE9F0">未到院重复对话：</td>
                <td><?= $ListItemShowC["retalk2"] ?>个</td>
                <td><?= $ListItemShowYesterdayC["retalk2"] ?>
                    个
                </td>
                <td><?= $ListItemShowMonthC["retalk2"] ?>个</td>
                <td>&nbsp;</td>
                <td align="right" bgcolor="#CCE9F0">行政无效对话：</td>
                <td><?= $ListItemShowC["notalk"] ?>个</td>
                <td><?= $ListItemShowYesterdayC["notalk"] ?>
                    个
                </td>
                <td><?= $ListItemShowMonthC["notalk"] ?>个</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?= $ListItemShowC["bqq"] ?>个</td>
                <td><?= $ListItemShowYesterdayC["bqq"] ?>
                    个
                </td>
                <td><?= $ListItemShowMonthC["bqq"] ?>个</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td><?= $ListItemShowC["talkall"] + $ListItemShowC["bqq"] - $ListItemShowC["notalk"] ?>
                    个<br/>(企业QQ<?= $ListItemShowC["bqq"] ?>个)
                </td>
                ...
                <td><?= $ListItemShowMonthC["talkall"] + $ListItemShowMonthC["bqq"] - $ListItemShowMonthC["notalk"] ?>
                    个<br/>(企业QQ<?= $ListItemShowMonthC["bqq"] ?>个)
                </td>
                <td>&nbsp;</td>
                <td align="right" bgcolor="#CCE9F0">对话成本：</td>
                <td><?= round(($ListItemShowC["fmoney"] / $ListItemShowC["talkall"]), 2) ?>元</td>
                <td><?= round(($ListItemShowYesterdayC["fmoney"] / $ListItemShowYesterdayC["talkall"]), 2) ?>
                    元
                </td>
            ...
            <tr>
                ...
                <td><?= round(($ListItemShowC["issys"] / ($ListItemShowC["talkall"] - $ListItemShowC["notalk"]) * 100), 2) ?>
                    %
                </td>
                <td><?= round(($ListItemShowYesterdayC["issys"] / ($ListItemShowYesterdayC["talkall"] - $ListItemShowYesterdayC["notalk"]) * 100), 2) ?>
                    %
                </td>
                <td><?= round(($ListItemShowMonthC["issys"] / ($ListItemShowMonthC["talkall"] - $ListItemShowMonthC["notalk"]) * 100), 2) ?>
                    %
                </td>
                <td>&nbsp;</td>
                <td align="right" bgcolor="#CCE9F0">到诊率：</td>
                <td><?= round(($ListItemShowC["isfrom"] / ($ListItemShowC["talkall"] - $ListItemShowC["notalk"]) * 100), 2) ?>
                    %
                </td>
                <td><?= round(($ListItemShowYesterdayC["isfrom"] / ($ListItemShowYesterdayC["talkall"] - $ListItemShowYesterdayC["notalk"]) * 100), 2) ?>
                    %
                </td>
                <td><?= round(($ListItemShowMonthC["isfrom"] / ($ListItemShowMonthC["talkall"] - $ListItemShowMonthC["notalk"]) * 100), 2) ?>
                    %
                </td>
                <td>&nbsp;</td>
                <td align="right" bgcolor="#CCE9F0">成交率：</td>
                <td><?= round(($ListItemShowC["isok"] / $ListItemShowC["isfrom"] * 100), 2) ?>%</td>
                <td><?= round(($ListItemShowYesterdayC["isok"] / $ListItemShowYesterdayC["isfrom"] * 100), 2) ?>
                    %
                </td>
    ...
    <div class="Tinfo" style="text-align:center; border-bottom:solid 1px #cccccc;">
        <font color="green"><strong>&gt;&gt; 以下是截止<?= $today2 ?>项目数据 &lt;&lt;</strong>&nbsp;</font>
    </div>
    <div class="Content" style="border-top:solid 1px #999999; margin:20px 0px 0px 0px; padding:20px 0px 0px 0px;">
        <div class="Item"><strong>项目：<br/>咨询量：<br/>下单量：<br/>消费：<br/>咨询单体：</strong></div>
        <?
        foreach ($MonthAllItemContShowDataCont as $mk => $mv) {
            $ss2++;
            ?>
            <div class="Item<? if ($ss2 % 2 == 1) {
                echo " Item2";
            } ?>">
                <?
                $mk1 = dcode($mk);
                $ikshow = $ItemShowC2[$mk1];
                $onetalkprice = round(($mv[2] / $mv[1]), 2);
                if ($onetalkprice > 200) {
                    $onetalkprice = "<font color=\"#FF0000\"><strong>" . $onetalkprice . "</strong></font>";
                }
                if ($onetalkprice < 150 && $onetalkprice > 0) {
                ...
                if ($mv[1] > 0) {
                    echo $ikshow . "<br />" . $mv[1] . "<br />" . $mv[0] . "<br />" . $mv[2] . "<br />" . $onetalkprice;
                }
                ?>
            </div>
            <?
        }
        #echo $MonthAllItemContShowData;
        #print_r($MonthAllItemContShow);
        ?>
        <div class="clearit"></div>
    </div>
