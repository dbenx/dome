    ...
    if ($myaction != "emailshow") {
        ...
        <div class="Tinfo">
            ...
            <div style="float:left; position:relative;">
                ...
                总 咨 询：<?= $ListItemShowC["talkall"] + $ListItemShowC["bqq"] ?>个（商务通<?= $ListItemShowC["talkall"] ?>个，企业QQ<?= $ListItemShowC["bqq"] ?>个） | <?= $ListItemShowMonthC["talkall"] ?>（月）<br/>
                ...
                咨询成本：<?= round($ListItemShowC["fmoney"] / ($ListItemShowC["talkall"] + $ListItemShowC["bqq"] - $ListItemShowC["notalk"]), 2) ?>元/个<br/>
                <br/>
                ...
                下单成本：<?= round($ListItemShowC["fmoney"] / $ListItemShowC["issys"], 2) ?>元/个<br/>
                <br/>
                ...
                到诊成本：<?= round($ListItemShowC["fmoney"] / $ListItemShowC["isfrom"], 2) ?>元/个<br/>
                <br/>
                成交：<?= $ListItemShowC["isok"] ?>个<br/>
                成交率：<?= round(($ListItemShowC["isok"] / $ListItemShowC["isfrom"]) * 100, 2) ?>%<br/>
                成交成本：<?= round($ListItemShowC["fmoney"] / $ListItemShowC["isok"], 2) ?>元/个<br/>
                <br/>
