...
<table border="0" width="50%" cellpadding="2" cellspacing="1" class="Tb" style="float:left; margin:10px 0px 0px 0px;">
    <?
    foreach ($ListItemGroup as $kk => $vv) {
        ?>
        <tr>
            <td align="center" colspan="2"><strong><?= $vv["aname"] ?>(<?= $today2 ?>)</strong></td>
        </tr>
        <tr>
            <td>咨询量</td>
            <td><?= $vv["data"][1] ?>人</td>
...
<table border="0" width="50%" cellpadding="2" cellspacing="1" class="Tb" style="float:left; margin:10px 0px 0px 0px;">
    ...
    foreach ($ListItemGroupMonth as $kk => $vv) {
        ...
        ?>
        <tr>
            <td align="center" colspan="2"><strong><?= $vv["aname"] ?>(本月总数据)</strong></td>
        </tr>
        <tr>
            <td>咨询量</td>
            <td><?= $vv["data"][1] ?>人</td>
