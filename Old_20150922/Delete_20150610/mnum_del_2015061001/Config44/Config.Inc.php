...
$TipsCont = '欢迎您 <strong style="color:#008000;">' . $_SESSION["YumDamCname"] . '</strong> ！ <a href="./">查看列表</a> &nbsp; | &nbsp; <a href="./indata.php">数据导入</a> | <a href="./?at=templist">临时数据</a> &nbsp; | &nbsp; <a href="./ur.php">用户管理</a> | <a href="./pr.php">修改密码</a> &nbsp; | &nbsp; <a href="./?at=d">报表情况</a> &nbsp; | &nbsp; <a href="./login.php?m=exit" target="_self">退出登录</a>';
...
$YumDamMStatus = array("1" => "完美处理", "2" => "停机", "3" => "关机", "4" => "空号", "5" => "无法接通", "6" => "不需要联系");
